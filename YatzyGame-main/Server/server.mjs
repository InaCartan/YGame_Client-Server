...
import { getResults, results, selectScore, throwD, updateHoldStatus } from './Game/gameLogic.mjs';
...
app.post('/updateHold', (req, res) => {
    const { index, holdStatus } = req.body;
    updateHoldStatus(index, holdStatus);
    res.status(201).send();
});
